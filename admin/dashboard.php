...
// Traitement des formulaires (même code que précédemment - gardé intact)
...
<head>
    ...
    <title>Admin Dashboard - Ma Boutique</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="header">
        <div class="header-inner">
            <div class="logo">
                <a href="dashboard.php">Ma<span>Boutique</span> <span style="font-size: 14px; color:#666;">Admin</span></a>
            </div>
            <div class="user-info">
                <span class="user-name">👋 <?php echo htmlspecialchars($_SESSION['admin_nom']); ?></span>
        ...
        <div class="container">
            ...
            <?php if($action == 'dashboard'): ?>
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <h3>👨‍💼 Gestionnaires</h3>
                        <div class="stat-number"><?php echo $stats['total_managers']; ?></div>
                    </div>
                    <div class="stat-card">
                        <h3>🛍️ Produits</h3>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="?action=messages" class="btn btn-secondary btn-sm">Voir tous</a>
                    </div>
                    <div class="card-body">
            ...
            <?php if($action == 'products'): ?>
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <small style="color:#888;">Formats: JPG, JPEG, PNG, GIF, WEBP</small>
                            </div>
                            <div class="form-group">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>📦 Produits (<?php echo count($produits); ?>)</h2>
                    </div>
                    <div class="card-body">
                        <?php if(count($produits) == 0): ?>
                            <p style="text-align: center; color: #666; padding: 40px;">Aucun produit.</p>
                        <?php else: ?>
                            <div class="table-responsive">
                                <table>
                                    <thead>
                                        ...
                                        <?php foreach($produits as $produit): ?>
                                            <tr>
                                                ...
                                                <td class="action-buttons">
                                                    <button onclick='editProduct(<?php echo json_encode($produit); ?>)' class="btn btn-warning btn-sm">✏️</button>
                                                    <a href="?action=products&delete_product=<?php echo $produit['id_produit']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Supprimer ce produit ?')">🗑️</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
            ...
            <?php if($action == 'orders'): ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php if(count($commandes) == 0): ?>
                            <p style="text-align: center; color: #666; padding: 40px;">Aucune commande.</p>
                        <?php else: ?>
                            <div class="table-responsive">
                                <table>
                                    <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($commande['client_telephone']): ?>
                                                        <a href="tel:<?php echo $commande['client_telephone']; ?>" class="phone-link">📞 <?php echo htmlspecialchars($commande['client_telephone']); ?></a>
                                                    <?php else: ?>
                                                        <span style="color:#999;">-</span>
                                                    <?php endif; ?>
                                                 </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($client['telephone']): ?>
                                                    <a href="tel:<?php echo $client['telephone']; ?>" class="phone-link">📞 <?php echo $client['telephone']; ?></a>
                                                <?php else: ?>
            ...
            <?php if($action == 'managers'): ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" class="form-grid">
                            ...
                            <div class="form-group">
                                <button type="submit" name="add_manager" class="btn btn-primary">➕ Ajouter</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>👨‍💼 Gestionnaires (<?php echo count($gestionnaires); ?>)</h2>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table>
                                ...
                                <tbody>
                                    <?php foreach($gestionnaires as $gestionnaire): ?>
                                        <tr>
                                            ...
                                            <td><?php echo !empty($gestionnaire['email']) ? htmlspecialchars($gestionnaire['email']) : '-'; ?></td>
    ...
    <?php if($view_message && $view_message_id > 0): ?>
        ...
        <div class="message-detail">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h2 style="font-size: 20px;">📧 Détail du message</h2>
            ...
            <div class="message-detail-info">
                ...
                <div>
                    ...
                    <a href="tel:<?php echo htmlspecialchars($view_message['telephone']); ?>"><?php echo htmlspecialchars($view_message['telephone']); ?></a>
                </div>
                <div>
                    <strong>🏷️ Statut:</strong><br>
                    <form method="POST" style="display: inline-block;">
                        <input type="hidden" name="id_contact" value="<?php echo $view_message['id_contact']; ?>">
                        <select name="statut" onchange="this.form.submit()" style="padding: 6px; border-radius: 6px; border: 1px solid #ddd;">
    ...
    <?php else: ?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <form method="POST">
                    <button type="submit" name="mark_all_read" class="btn btn-secondary btn-sm" onclick="return confirm('Marquer tous les messages comme lus ?')">✅ Tout marquer lu</button>
                </form>
            </div>
            <div class="card-body">
                <?php 
        ...
        <div class="card" style="margin-top: 20px;">
            <details>
                <summary style="cursor: pointer; font-weight: 500; padding: 15px; background: #f9fafb; border-radius: 8px;">
...
<?php endif; ?>
            ...
            <?php if($action == 'categories'): ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" style="margin-bottom: 30px; padding: 20px; background: #f9fafb; border-radius: 10px;">
                            <h3 style="margin-bottom: 15px; font-size: 16px;">➕ Ajouter une catégorie</h3>
                            <div class="form-group">
                                <label>Nom de la catégorie *</label>
                                <input type="text" name="nom" placeholder="Ex: Électronique, Vêtements..." required>
                            </div>
                            <button type="submit" name="add_category" class="btn btn-primary">➕ Ajouter</button>
                        </form>
                        
                        <h3 style="margin-bottom: 15px; font-size: 16px;">📋 Liste des catégories</h3>
                        <?php if(count($categories) == 0): ?>
                            <p style="text-align: center; color: #666; padding: 20px;">Aucune catégorie.</p>
                        <?php else: ?>
                            <div class="table-responsive">
                                <table>
                                    <thead>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" id="cat_edit_<?php echo $categorie['id_categorie']; ?>" value="<?php echo htmlspecialchars($categorie['nom']); ?>" style="display:none; width:150px;" class="form-control">
                                                </td>
                                                <td><span class="badge badge-info"><?php echo $product_count; ?></span></td>
                                                <td class="action-buttons">
                                                    <button onclick="editCategory(<?php echo $categorie['id_categorie']; ?>)" class="btn btn-warning btn-sm" id="cat_edit_btn_<?php echo $categorie['id_categorie']; ?>">✏️</button>
                                                    <button onclick="saveCategory(<?php echo $categorie['id_categorie']; ?>)" class="btn btn-success btn-sm" id="cat_save_btn_<?php echo $categorie['id_categorie']; ?>" style="display:none;">💾</button>
                                                    <a href="?action=categories&delete_category=<?php echo $categorie['id_categorie']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Supprimer cette catégorie ?')">🗑️</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
            ...
            <?php if($action == 'statuses'): ?>
                <div class="card">
                    <div class="card-header">
                        <h2>🏷️ Gestion des statuts</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" style="margin-bottom: 30px; padding: 20px; background: #f9fafb; border-radius: 10px;">
                            <h3 style="margin-bottom: 15px; font-size: 16px;">➕ Ajouter un statut</h3>
                            <div class="form-group">
                                <label>Nom du statut *</label>
                                <input type="text" name="nom" placeholder="Ex: En attente, Livrée..." required>
                            </div>
                            <button type="submit" name="add_status" class="btn btn-primary">➕ Ajouter</button>
                        </form>
                        
                        <h3 style="margin-bottom: 15px; font-size: 16px;">📋 Liste des statuts</h3>
                        <?php if(count($status_list) == 0): ?>
                            <p style="text-align: center; color: #666; padding: 20px;">Aucun statut.</p>
                        <?php else: ?>
                            <div class="table-responsive">
                                <table>
                                    <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span id="status_name_<?php echo $status['id_status']; ?>">
                                                        <span class="badge badge-info" style="margin-right: 8px;">●</span>
                                                        <?php echo htmlspecialchars($status['nom']); ?>
                                                    </span>
                                                    <input type="text" id="status_edit_<?php echo $status['id_status']; ?>" value="<?php echo htmlspecialchars($status['nom']); ?>" style="display:none; width:150px;" class="form-control">
                                                </td>
                                                <td><span class="badge badge-info"><?php echo $order_count; ?></span></td>
                                                <td class="action-buttons">
                                                    <button onclick="editStatus(<?php echo $status['id_status']; ?>)" class="btn btn-warning btn-sm" id="status_edit_btn_<?php echo $status['id_status']; ?>">✏️</button>
                                                    <button onclick="saveStatus(<?php echo $status['id_status']; ?>)" class="btn btn-success btn-sm" id="status_save_btn_<?php echo $status['id_status']; ?>" style="display:none;">💾</button>
                                                    <a href="?action=statuses&delete_status=<?php echo $status['id_status']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Supprimer ce statut ?')">🗑️</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
        ...
        <div class="footer">
            <p>&copy; <?php echo date('Y'); ?> Ma Boutique - Administration</p>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form method="POST" id="editOrderForm">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_status" id="order_status" class="form-control">
                            <?php foreach($status_list as $status): ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="adresse_livraison" id="order_address" rows="2" class="form-control"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                            <select id="add_product_select" style="flex: 1; padding: 8px; border-radius: 6px; border: 1px solid #ddd;">
                                <option value="">-- Sélectionner --</option>
                    ...
                    <div style="margin: 20px 0; padding: 15px; background: #f9fafb; border-radius: 8px; text-align: right;">
                        <strong>💰 Total : </strong>
                        <span id="order_total_display" style="font-size: 20px; color: #2563eb;">0 DH</span>
                    </div>
    ...
    <script>
        ...
        function editProduct(product) {
            ...
            if(product.image) {
                imageContainer.innerHTML = `<p>Image actuelle :</p><img src="../uploads/products/${product.image}" class="current-image"><br><small>Laissez vide pour conserver</small>`;
            } else {
                imageContainer.innerHTML = '<small>Aucune image</small>';
            }
        ...
        function saveCategory(id) {
            ...
            form.innerHTML = `<input name="id_categorie" value="${id}"><input name="nom" value="${escapeHtml(newName)}"><input name="edit_category" value="1">`;
        ...
        function saveStatus(id) {
            ...
            form.method = 'POST';
            form.style.display = 'none';
            form.innerHTML = `<input name="id_status" value="${id}"><input name="nom" value="${escapeHtml(newName)}"><input name="edit_status" value="1">`;
            document.body.appendChild(form);
            form.submit();
        }
    </script>
