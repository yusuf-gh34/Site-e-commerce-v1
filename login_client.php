...
<head>
    ...
    <title>Connexion Client - Ma Boutique</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-box">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <div class="form-group">
                    ...
                    <input type="tel" id="telephone" name="telephone" required 
                           placeholder="Entrez votre numero" value="<?php echo isset($_POST['telephone']) ? htmlspecialchars($_POST['telephone']) : ''; ?>">
                </div>
            ...
            <div class="info-text">
                Nouveau client ? <a href="register.php" style="color: #2563eb; text-decoration: none;">Creer un compte</a>
            </div>
        </div>
    </div>
