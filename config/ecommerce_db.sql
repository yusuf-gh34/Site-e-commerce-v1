...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 08 avr. 2026 à 18:30
...
INSERT INTO `commande` (`id_commande`, `id_status`, `prix_totale`, `date_commande`, `id_utilisateur`, `adresse_livraison`, `notes`) VALUES
(20, 5, 6000.00, '2026-04-07 15:40:21', 23, 'campus mghila', NULL),
(21, 5, 598.00, '2026-04-07 16:07:26', 22, 'oued zem, Maroc', NULL),
(29, 1, 299.00, '2026-04-08 10:55:33', 23, 'tadla,Maroc', NULL),
(30, 4, 6000.00, '2026-04-08 11:32:36', 22, 'oued zem,Maroc', NULL),
(31, 2, 60.00, '2026-04-08 12:50:46', 23, 'tadla,Maroc', NULL);
...
(8, 'Iphone 13', 'Iphone 13 normal 128GB', 3500.00, 10, '1775228025_69cfd47922551.webp', 1),
(9, 'Play Station 5 ', 'Console Ultra HD 8K - AMD Ryzen Zen 2 - AMD RDNA 2 10.28 TFLOPs - 16 Go GDDR6 - SSD 825 Go - son 3D - manette sans fil', 6000.00, 6, '1775468399_69d37f6fbfc87.jpg', 7),
(11, 'Adidas Chaussures Ultimashow 2.0 - IG4396', 'Sneaker légère conçue en partie avec des matériaux recyclés.', 299.00, 10, '1775574260_69d51cf4250da.jpg', 2),
(12, 'kit de Bandes Élastique Fitness Résistance -150 LBS en Total- 11 Pièces de Résistance', 'Obtenez un entraînement de résistance vigoureux et complet du corps, sans l\'encombrement des poids encombrants et des équipements encombrants avec cet ensemble de bandes de résistance à tubes empilables de qualité supérieure, fabriquées à partir de caoutchouc de la plus haute qualité pour une durabilité maximale\r\nLes bandes de résistance empilables vous permettent de personnaliser l\'intensité de votre entraînement : vous pouvez utiliser une ou plusieurs bandes selon le niveau de résistance souhaité.\r\nN\'importe quelle combinaison de bandes peut être utilisée en même temps, sans l\'inconvénient de jongler avec plusieurs poignées avec chaque bande.\r\nCet ensemble est léger et portable, vous pouvez donc vous entraîner presque n\'importe où.\r\nLa facilité d\'utilisation et la large gamme de niveaux de résistance rendent cet ensemble idéal pour les débutants en fitness et les fanatiques d\'entraînement.', 60.00, 38, '1775648968_69d640c8e7856.jpg', 4);
...
(21, 598.00, '2026-04-07 16:07:26', 1, 21),
(29, 299.00, '2026-04-08 10:55:33', 0, 29),
(30, 6000.00, '2026-04-08 11:32:36', 0, 30),
(31, 60.00, '2026-04-08 12:50:46', 0, 31);
...
(22, '0611111111', NULL, 'anas ilhami', 'campus tjhiz', '$2y$10$qdqJYCnxIVXWwOCqcdR3AOqwU0s3dck5QBWUiu4nCpwOplTfMdDwm', 3, '2026-04-03 17:14:54', '2026-04-06 10:26:15'),
...
(26, '0687654321', NULL, 'adam ghanem', 'oulfa,Casablanca', '$2y$10$/TVZgsXmXhcW4uARN.UHpu.U/KVPVwrpbov54f5pd2GHX6i2BV7iW', 2, '2026-04-08 14:57:24', '2026-04-08 14:57:24');
...
--
ALTER TABLE `commande`
  MODIFY `id_commande` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT pour la table `contact`
--
ALTER TABLE `contact`
  MODIFY `id_contact` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT pour la table `ligne_commande`
--
ALTER TABLE `ligne_commande`
  MODIFY `id_ligne_commande` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `reglement`
  MODIFY `id_reglement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
